...
class Controller_MP_Function extends Controller_BaseController
{
    ...
    public function action_index(){
        ...
        $this->template->content = \View::forge("{$this->theme}/wxaccount/config");
    }
    ...
    public function action_menu_save($id = 0){
        ...
        \View::set_global($params);
        $this->template->content = \View::forge("{$this->theme}/mp/coustom_menu/index");
    }
    ...
    public function action_menus(){
        ...
        \View::set_global($params);
        return \View::forge("{$this->theme}/mp/coustom_menu/moblie");
    }
    ...
    public function action_reply(){
        ...
        \View::set_global($params);
        $this->template->content = \View::forge("{$this->theme}/wxaccount/material/auto_reply");
    }
    ...
    public function action_reply_save($id = 0){
        ...
        \View::set_global($params);
        $this->template->content = \View::forge("{$this->theme}/wxaccount/material/reply");
    }
    ...
    public function action_records($id = 0){
        ...
        \View::set_global($params);
        $this->template->content = \View::forge("{$this->theme}/wxaccount/records");
    }
}
